...
- **2026-09-14** — Expected clears the day after Receive (`markedReceivedOn`); the Receive checkbox unchecks on that same roll-forward; weekday mins per SKU × location via `StockMinSchedule` + `/admin/minimums`. Migration `20260914010000_expected_reset_and_daily_mins`.
